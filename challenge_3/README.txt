...
[] build ui using React all in app.jsx one file
    [] Create Next button - to guide the user through F1 to F3
        [] Saves data to db when next is clicked
    [] homepage should have a checkout button
        [] Create data to db when checkout clicked 
    [] F1 collects name, email, and password for account creation.
    [] F2 collects ship to address (line 1, line 2, city, state, zip code) and phone number.
    [] F3 collects credit card #, expiry date, CVV, and billing zip code.
    [] Summary page with Purchase button
        [] when Purchase return to homepage

[] use mongo or mysql to store data 
